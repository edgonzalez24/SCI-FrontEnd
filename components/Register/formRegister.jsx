...
const formRegister= () => {
  ...
  return (
    ...
    initialValues={{ email: "" , name: "", year:"", name:"" , password:"", genre: ""}}
    ...
    validationSchema={Yup.object().shape({
      name: Yup.string()
        .min(1, "Your name Brand is too short")
            ...
            <form action="#" className="w-full lg:max-w-md" onSubmit={handleSubmit}>
              ...
              <InputLabel htmlFor="age-native-simple">Age</InputLabel>
                <Select
                  ...
                  onChange={handleChange}
                >
                  <option aria-label="None" value="">Selecciona tu edad</option>
              ...
              <div className="mb-1">
                <InputLabel htmlFor="age-native-simple">Género</InputLabel>
                  <Select
                    native
                    name="year"
                    className="w-full"
