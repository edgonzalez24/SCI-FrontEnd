        ...
        return (
            <div className="lg:h-screen bg_blue_gray w-full">
              <div className="container mx-auto flex justify-center items-center h-full">
                <div className="lg:w-4/6 w-full mt-16 lg:mt-0">
                  <h2 className="text-2xl lg:text-3xl text-blue-500 font-bold text-center animated slideInRight">Agregar libros a inventario</h2>
